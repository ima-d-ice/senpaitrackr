...
import { ThemeContext } from '../context/ThemeContext'; // Assuming this context provides 'light' or 'dark'
...
const Auth = () => {
    ...
    const { theme } = useContext(ThemeContext); // Use this to toggle Tailwind's dark mode if not done globally
    ...
    // Add 'dark' class to html tag if theme is dark, or manage through Tailwind config
    // For example, in your App.js or index.js:
    // useEffect(() => {
    //   if (theme === 'dark') {
        ...
        <div className={`min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-90 to-teal-150 dark:from-neutral-900 dark:to-teal-950 p-4 transition-colors duration-300`} data-theme={theme}>
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-teal-700 dark:text-teal-300 mt-2">Track your anime journey.</p>
                </div>
                ...
                <div className="bg-neutral-300/45 dark:bg-neutral-800/70 backdrop-blur-xl shadow-2xl rounded-xl p-6 sm:p-8 space-y-6 border border-teal-300/50 dark:border-teal-700/60">
                    <form onSubmit={handleSignUp} className="space-y-6">
                        <h2 className="text-2xl font-semibold text-center text-teal-800 dark:text-teal-100">Create an Account</h2>
