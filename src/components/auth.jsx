            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white dark:bg-neutral-800 p-8 rounded-xl shadow-2xl">
                    <form onSubmit={handleSignUp}>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-150 ease-in-out"
                        >
                            Sign Up
                        </button>
                    </form>
                    ...
                    <button
                        ...
                        className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-150 ease-in-out flex items-center justify-center"
                    >
                ...
                <p className="text-center text-sm text-neutral-600 dark:text-neutral-400 mt-8">
                    Already have an account? <a href="#" onClick={(e) => { e.preventDefault(); /* Implement sign-in navigation or modal */ alert("Navigate to Sign In form/page"); }} className="font-medium text-teal-600 hover:text-teal-500 dark:text-teal-400 dark:hover:text-teal-300">Sign In</a>
                </p>
            </div>
        </div>
